...
echo "<br><div class='container-fluid'>
        ...
        while( $objFila = pg_fetch_object($rs) )
         ...
         <td>".$objFila->deshor." </td>
               ...
               echo "</table><br><a href='../vista/horario_coordinador.php' class='btn btn-info' role='button'>Volver</a></div> ";
      }
			else
				echo "<br><div class='panel panel-danger'>
      <div class='panel-heading'>No se encontraro horario<A HREF='../vista/horario_coordinador.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
		}
		else
			$ok = false;
