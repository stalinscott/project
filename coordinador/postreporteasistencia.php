   ...
   Hasta:<input class='form-control' id='cedper' type='cedper'  placeholder='Cedula de identidad' name='cedper' required='' value='$hasta' disabled >
    ...
    { 
      if( pg_num_rows($rs) > 0 )
      {
         ...
         echo "<div class='col-sm-12 text-right'><a target='_blank' href='../coordinador/grafica.php?id=".$codificado =
...
echo "<a href='../vista/reporte_asistencias_coordinador.php' class='btn btn-info' role='button'>Volver</a> </div></div><br><br><br><br><br><br>";
      ...
      <div class='panel-heading'>No se encontraron Asistencias<A HREF='../vista/reporte_asistencias_coordinador.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
