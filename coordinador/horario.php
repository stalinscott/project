...
<div class="sidebar-nav">
      <div class="navbar navbar-default" role="navigation">
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          ...
          <li class="active"><a href="horario_coordinador.php"><img src="../images/1.1.png" alt="#"/> Horario</a></li>
          <li><a href="../vista/justificar_dia_coordinador.php"><img src="../images/1.2.png" alt="#"/> Justificar</a></li>
            <li><a href="../vista/consultar_asistencia_coordinador.php"><img src="../images/1.2.png" alt="#"/> Consultar</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
...
function loadLog() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../coordinador/postconsultarhorario.php", true);
