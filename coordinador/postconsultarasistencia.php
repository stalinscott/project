...
AND sno_unidadadm.prouniadm=personal.prouniadm
 ...
 base64_encode($fi)."' class='btn btn-danger'>Exportar a PDF</a> <a href='../vista/consultar_asistencia_coordinador.php' class='btn btn-info' role='button'>Volver</a></div>  <br> <br>     ";
