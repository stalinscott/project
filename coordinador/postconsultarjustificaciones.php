...
<div class='col-sm-12 slideanim'>
 ...
 base64_encode($_POST['sno_unidadadm'])."' class='btn btn-danger'>Exportar a PDF</a> <a href='../vista/consultar_justificaciones_coordinador.php' class='btn btn-info' role='button'>Volver</a></div>    ";
          ...
          echo "
            ...
            <td>".$objFila->nom_justificacion." </td>
             ...
             <td>".$objFila->status." </td>
               <TD><A HREF='../vista/modificarjustificacion_coordinador.php?id=".$codificado = base64_encode($objFila->id_justificacion)."' title='Modificar'><IMG SRC='../images/navegador.png' ALT='modificar'></A>            
                      <A HREF='../vista/borrarjustificacion_coordinador.php?id=".$codificado = base64_encode($objFila->id_justificacion)."' title='Borrar'><IMG SRC='../images/borrar.png' ALT='borrar'></A></TD>
               </tr></div>";
               echo "</table><br></div> ";
      }
      else
      echo "<br><div class='panel panel-danger'>
      <div class='panel-heading'>No se encontro justificaciones por inasistencia<A HREF='../vista/consultar_justificaciones_coordinador.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
    }
    else
      $ok = false;
