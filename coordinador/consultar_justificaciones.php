...
<div class="col-sm-9 text-left">
  ...
  <li ><a href="../vista/justificar_dia_coordinador.php">Crear Justificar</a></li>
  <li class="active"><a href="../vista/consultar_justificaciones_coordinador.php">Consultar Justificaciones</a></li>
</ul>
   <div id="login">        
...
function loadLog() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../coordinador/postconsultarjustificaciones.php", true);
