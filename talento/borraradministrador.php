...
";
               echo "</table><br><div class='well well-sm'><center>¿Seguro desea eliminar este administrador?</Center></div>
      			<center><a  href='../vista/postborraradministrador_talento.php?id=".$obj->cedper."' class='btn btn-success' role='button'>Si</a>
               <a  href='../vista/consultar_administrador_talento.php' class='btn btn-danger role='button'>No</a></center></div>";
               echo "</div>";
            	}
            else
                $ok = false;
