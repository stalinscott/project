...
echo $_POST["email"];
echo "        ";
echo "<a href='../vista/justificar_dia_talento.php' class='btn btn-info' role='button'>Volver</a> ";
echo "<br>";
echo "<br>";
...
<div class='well well-sm'><center>¿Desea Justificar este dia?</Center></div>
      			<center><a  href='../vista/postjustificardia_talento.php?id=".$codificado = base64_encode($_POST["cedper"])."?fecha=".$codificado2 = base64_encode($_POST["email"])."' class='btn btn-success' role='button'>Si</a>
               <a  href='../vista/justificar_dia_talento.php' class='btn btn-danger role='button'>No</a></center></div>
</div>
