...
<div class="sidebar-nav">
  ...
  <li><a href="../vista/crear_horario_talento.php">Crear Horario</a></li>
  <li class="active"><a href="../vista/consultar_horario_talento.php">Consultar Horarios</a></li>
</ul>
   <div id="login">        
...
function loadLog() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../talento/postconsultarhorario.php", true);
