...
;";
    ...
    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><center><a HREF='vernotificacion_talento.php?id=".$codificado = base64_encode($data->id_notificacion)."'><img src='../images/10.png' alt='#'/> <strong>Fecha:</strong> ".$data->fecha_jornada." <strong>Hora:</strong> ".$data->hora." <strong>Dia:</strong> ".$data->dia." <strong>Cedula:</strong> ".$data->cedper." <br>".$data->descri."   </center> </div>  ";
      }
      echo "";
