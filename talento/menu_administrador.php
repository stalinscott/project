...
<div class="navbar navbar-inverse navbar-fixed-top" rol="navigation">
		<div class="navbar-collapse collapse">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<li  class="active"><a href="administrador_talento.php"><img src="../images/4.png" alt="#"/>Administrador </a></li>
	...
	<div id="seccionRecargar"></div>
      ...
      echo " <center>
              <a href='vernotificaciones_talento.php' '><button type='button' class='btn btn-link'>Ver Notificaciones</button></a></center>
            </ul> </td></tr>";
            ...
            ?>
          			...
          			<li><a href="index_talento.php" class="data-toggle">
...
<script type="text/javascript">
	$(document).ready(function(){
		setInterval(
				function(){
					$('#seccionRecargar').load('../talento/notificacion.php');
				},2000
			);
	});
</script>
