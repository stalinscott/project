...
<div class="sidebar-nav">
      <div class="navbar navbar-default" role="navigation">
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          ...
          <li><a href="../vista/justificar_dia_talento.php"> <img src="../images/1.2.png" alt="#"/> Justificar</a></li>
            <li class="active"><a href="consultar_asistencia_talento.php"> <img src="../images/1.1.png" alt="#"/> Consultar</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
  ...
  <li><a href="../vista/consultar_asistencia_talento.php">Empleado</a></li>
  <li  class="active"><a href="../vista/reporte_asistencias.php">Departamento</a></li>
</ul>
<br>
   <div id="login">        
...
function loadLog() {
...

 {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../talento/postreporteasistencia.php", true);
