...
include_once('../includes/database.php');
 ...
 base64_encode($_POST['sno_unidadadm'])."' class='btn btn-danger'>Exportar a PDF</a> <a href='../vista/consultar_empleado_talento.php' class='btn btn-info' role='button'>Volver</a></div>  <br> <br>     ";
            ...
            <td>".$objFila->cedper." </td>
             ...
             <td>".$objFila->apellido." </td>
              <td>".$objFila->deshor." </td>
               ...
               <TD><A HREF='../vista/modificarempleado_talento.php?id=".$codificado = base64_encode($objFila->cedper)."' title='Modificar'><IMG SRC='../images/navegador.png' ALT='modificar'></A>            
                      <A HREF='../vista/borrarempleado_talento.php?id=".$codificado = base64_encode($objFila->cedper)."' title='Borrar'><IMG SRC='../images/borrar.png' ALT='borrar'></A></TD>
               </tr></div>";
      }
      else
      echo "<br><div class='panel panel-danger'>
      <div class='panel-heading'>No se encontraro personal<A HREF='../vista/consultar_empleado_talento.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
    }
    else
      $ok = false;
