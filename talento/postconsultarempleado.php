            ...
            <td>".$objFila->cedper." </td>
             ...
             <td>".$objFila->apellido." </td>
              <td>".$objFila->desuniadm." </td>
               ...
               echo "</table><br><a href='../vista/consultar_empleado_talento.php' class='btn btn-info' role='button'>Volver</a></div> ";
      }
      else
      echo "<br><div class='panel panel-danger'>
      <div class='panel-heading'>No se encontraro personal<A HREF='../vista/consultar_personal_talento.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
    }
    else
      $ok = false;
