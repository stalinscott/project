...
<div class='col-sm-12 slideanim'>
 ...
 base64_encode($_POST['sno_unidadadm'])."' class='btn btn-danger'>Exportar a PDF</a> <a href='../vista/consultar_justificaciones_talento.php' class='btn btn-info' role='button'>Volver</a></div>    ";
