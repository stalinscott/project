...
<div class="sidebar-nav">
  ...
  <li><a href="registrar_asistencia_empleado.php">Entrada</a></li>
  <li class="active"><a href="registrar_asistencia_empleado2.php">Salida</a></li>
</ul>
    </div>
    ...
    <div class="col-sm-6">
      <input class="form-control" id="fecha_jornada" type="txt" placeholder="<?php echo $fecha; ?> " value="<?php echo $fecha; ?> " disabled>
    </div>
  </div>
  <div class="form-group">
    <label for="disabledInput" class="col-sm-3 control-label">Hora:</label>
    <div class="col-sm-6">
      <input class="form-control" id="h_salida" type="text" placeholder="<?php echo $hora; ?> " value="<?php echo $hora; ?> " disabled>
    </div>
  </div>
  <div class="col-sm-6">
