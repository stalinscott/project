  ...
  and horario.minorguniadm='$minorguniadm'
   ...
   and horario.prouniadm='$prouniadm' and sno_unidadadm.depuniadm=horario.depuniadm and sno_unidadadm.ofiuniadm=horario.ofiuniadm and sno_unidadadm.minorguniadm=horario.minorguniadm and sno_unidadadm.uniuniadm=horario.uniuniadm and sno_unidadadm.prouniadm=horario.prouniadm";
    ...
    if( $rs )
    {
        ...
        while( $objFila = pg_fetch_object($rs) )
          echo "
           ...
           <td>".$objFila->deshor." </td>
               ...
               <TD><A HREF='../vista/modificarhorario_root.php?id=".$codificado = base64_encode($objFila->id_horario)."' title='Modificar'><IMG SRC='../images/navegador.png' ALT='modificar'></A>            
                      <A HREF='../vista/borrarhorario_root.php?id=".$codificado = base64_encode($objFila->id_horario)."' title='Borrar'><IMG SRC='../images/borrar.png' ALT='borrar'></A></TD>
               </tr></div>";
      ...
      <div class='panel-heading'>No se encontraro horario<A HREF='../vista/consultar_horario_root.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
    }
    else
      $ok = false;
    return $ok;
