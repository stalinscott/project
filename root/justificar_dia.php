...
<div class="col-sm-9 text-left">
  ...
  <li class="active"><a href="../vista/justificar_dia_root.php">Crear Justificar</a></li>
  <li><a href="../vista/consultar_justificaciones_root.php">Consultar Justificaciones</a></li>
</ul>
<br>
   <div id="login">        
...
if (comentario==0)
 {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../root/postconsultarinasistencia.php", true);
