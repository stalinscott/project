...
";
    ...
    $sql1 = "SELECT justificacion.id_justificacion, sn_cargo.cargo ,justificacion.comentario,justificacion.fecha_creacion,justificacion.id_tipo_justificacion,
justificacion.fecha_justificar,justificacion.cedper,justificacion.status,personal.nombres,personal.apellido,
...
personal.prouniadm,personal.estatus,tipo_justificacion.nom_justificacion, sno_unidadadm.desuniadm
  FROM public.sn_cargo ,public.justificacion,public.personal,public.tipo_justificacion, public.sno_unidadadm 
          ...
          echo "
            ...
            <td>".$objFila->nom_justificacion." </td>
             ...
             <td>".$objFila->status." </td>
               <TD><A HREF='../vista/modificarjustificacion_root.php?id=".$codificado = base64_encode($objFila->id_justificacion)."' title='Modificar'><IMG SRC='../images/navegador.png' ALT='modificar'></A>            
                      <A HREF='../vista/borrarjustificacion_root.php?id=".$codificado = base64_encode($objFila->id_justificacion)."' title='Borrar'><IMG SRC='../images/borrar.png' ALT='borrar'></A></TD>
               </tr></div>";
               echo "</table><br><a href='../vista/consultar_justificaciones_root.php' class='btn btn-info' role='button'>Volver</a></div> ";
      }
      else
      echo "<br><div class='panel panel-danger'>
      <div class='panel-heading'>No se encontro justificaciones por inasistencia<A HREF='../vista/consultar_justificaciones_root.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
    }
    else
      $ok = false;
