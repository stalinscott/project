  ...
  <br> <?php    
      ...
      $id=$_GET["id"];
       $decodificado = base64_decode($id);
        ...
        {
            $sql = "SELECT id_notificacion, cedper, fecha_jornada, dia, depuniadm, ofiuniadm, 
       minorguniadm, uniuniadm, prouniadm, status,descri,hora
  FROM public.notificacion where id_notificacion='$decodificado'";
