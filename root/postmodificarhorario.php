...
if (isset($_POST))
{
    echo "<br><br><br><div class='panel panel-success'>
     ...
     echo "
            ...
            <td>".$_POST["deshor"]." </td>
                <td><b>Entrada:</b><br>".$_POST["lunes_e"]." <br> <b>Salida:</b><br>".$_POST["lunes_s"]." </td>
                <td><b>Entrada:</b><br>".$_POST["martes_e"]." <br> <b>Salida:</b><br>".$_POST["martes_s"]." </td>
                <td><b>Entrada:</b><br>".$_POST["miercoles_e"]." <br> <b>Salida:</b><br>".$_POST["miercoles_s"]."</td>
               <td><b>Entrada:</b><br>".$_POST["jueves_e"]." <br> <b>Salida:</b><br>".$_POST["jueves_s"]." </td>
               <td><b>Entrada:</b><br>".$_POST["viernes_e"]." <br> <b>Salida:</b><br>".$_POST["viernes_s"]." </td>
               <td><b>Entrada:</b><br>".$_POST["sabado_e"]." <br> <b>Salida:</b><br>".$_POST["sabado_s"]." </td>
               <td><b>Entrada:</b><br>".$_POST["domingo_e"]." <br> <b>Salida:</b><br>".$_POST["domingo_s"]." </td>
               </tr>";
               echo "</table><br><a href='../vista/consultar_horario_root.php' class='btn btn-info' role='button'>Volver</a></div>
    ";
