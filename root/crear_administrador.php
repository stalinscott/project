      ...
      <div class="navbar navbar-default" role="navigation">
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="crear_administrador.php"><img src="../images/1.1.png" alt="#"/> Crear</a></li>
            <li><a href="consultar_administrador.php"><img src="../images/1.2.png" alt="#"/> Consultar</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
...
<select class="form-control" required="required" name="id_rol" id="id_rol">
  ...
  include_once('../includes/database.php');
  ini_set("display_errors", "on");
  $sql = "SELECT id_rol, nom_rol FROM public.rol WHERE id_rol!='5' AND id_rol!='1' AND id_rol!='6';";
  $ok = true;
  $rs = pg_query( $conexion, $sql );
  while( $objFila = pg_fetch_object($rs) ){
