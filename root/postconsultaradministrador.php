            ...
            <td>".$objFila->cedper." </td>
             ...
             <td>".$objFila->apellido." </td>
              <td>".$objFila->desuniadm." </td>
               ...
               <TD><A HREF='../vista/modificaradministrador_root.php?id=".$codificado = base64_encode($objFila->cedper)."' title='Modificar'><IMG SRC='../images/navegador.png' ALT='modificar'></A>            
                      <A HREF='../vista/borraradministrador_root.php?id=".$codificado = base64_encode($objFila->cedper)."' title='Borrar'><IMG SRC='../images/borrar.png' ALT='borrar'></A></TD>
               </tr></div>";
