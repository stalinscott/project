...
function paginate(offset, limit)
{
    ...
    $.get("data3.php/?offset=" + offset + "&limit=" + limit, function(data){
        if(data)
        {
            ...
            {
                $html += " <tr> <td> " + json.products[datos].cedper + " </td><td> " + json.products[datos].nombres + "</td><td> " + json.products[datos].apellido + "</td><td> " + json.products[datos].desorg + " </td><td> " + json.products[datos].descar + " </td></tr>";
