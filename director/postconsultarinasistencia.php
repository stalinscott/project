...
<div class='well well-sm'><center>¿Desea justificar otro dia?</Center></div>
      			<center><a  href='../vista/justificar_dia_director.php' class='btn btn-success' role='button'>Si</a>
               <a  href='../vista/consultar_justificaciones_director.php' class='btn btn-danger role='button'>No</a></center></div>
</div></div>
...
<div class='well well-sm'><center>¿Desea Justificar este dia?</Center></div>
      			<center><a  href='../vista/postjustificardia_director.php?cedper=".$codificado = base64_encode($_POST["cedper"])."&f=".$codificado1 = base64_encode($_POST["email"])."&t=".$codificado2 = base64_encode($_POST["tipo"])."&c=".$codificado3 = base64_encode($_POST["comentario"])."' class='btn btn-success' role='button'>Si</a>
               <a  href='../vista/consultar_justificaciones_director.php' class='btn btn-danger role='button'>No</a></center></div>
</div></div>
