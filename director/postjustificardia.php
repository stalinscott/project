...
<div class="sidebar-nav">
      <div class="navbar navbar-default" role="navigation">
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          ...
          <li class="active"><a href="asistencia_director.php"><img src="../images/1.1.png" alt="#"/> Asistencia</a></li>
...
echo "</table><a href='../vista/justificar_dia_director.php' class='btn btn-info' role='button'>Volver</a></div>";
}
