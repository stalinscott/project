...
<div class="navbar navbar-inverse navbar-fixed-top" rol="navigation">
		<div class="navbar-collapse collapse">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					<li class="active"><a href="index_director.php"><img src="../images/1.png" alt="#"/>Inicio </a></li>
					<li><a href="administrador_director.php"><img src="../images/4.png" alt="#"/>Administrador </a></li>
					<li><a href="empleado_director.php"><img src="../images/5.png" alt="#"/>Empleado </a></li>
	...
	<div id="seccionRecargar"></div><?php
      ...
      echo " <center>
              <a href='vernotificaciones_director.php' '><button type='button' class='btn btn-link'>Ver Notificaciones</button></a></center>
            </ul> </td></tr>";
