...
<div class="sidebar-nav">
      <div class="navbar navbar-default" role="navigation">
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          ...
          <li class="active"><a href="vernotificaciones_director.php"><img src="../images/1.1.png" alt="#"/> Notificaciones</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
...
;";
    ...
    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><center><a HREF='vernotificacion_director.php?id=".$codificado = base64_encode($data->id_notificacion)."'><img src='../images/10.png' alt='#'/> <strong>Fecha:</strong> ".$data->fecha_jornada." <strong>Hora:</strong> ".$data->hora." <strong>Dia:</strong> ".$data->dia." <strong>Cedula:</strong> ".$data->cedper." <br>".$data->descri."   </center> </div>  ";
      }
      echo "";
