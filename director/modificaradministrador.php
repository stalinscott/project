...
<select class="form-control" required="required" name="id_rol" id="id_rol">
  ...
  $sql = "SELECT id_rol, nom_rol FROM public.rol WHERE id_rol!='5' AND id_rol!='6' AND id_rol!='1' AND id_rol!='2' AND id_rol!='3';";
  $ok = true;
  $rs = pg_query( $conexion, $sql );
...
function loadLog() {
  ...
  if (cla2==0)
 {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../director/postmodificaradministrador.php", true);
