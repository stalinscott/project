...
<div class="sidebar-nav">
  ...
  <div class="col-sm-9 text-left">
      <div class="panel-heading">
        ...
        <li ><a href="../vista/consultar_asistencia_director.php">Empleado</a></li>
  <li class="active"><a href="../vista/reporte_asistencias_director.php">Departamento</a></li>
</ul>
<br>
   <div id="login">        
...
function loadLog() {
...

 {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../director/postreporteasistencia.php", true);
