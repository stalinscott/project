...
include_once('../includes/database.php');
 ...
 base64_encode($_POST['sno_unidadadm'])."' class='btn btn-danger'>Exportar a PDF</a> <a href='../vista/consultar_empleado_director.php' class='btn btn-info' role='button'>Volver</a></div>  <br> <br>     ";
      ...
      <div class='panel-heading'>No se encontraro personal<A HREF='../vista/consultar_empleado_director.php' title='Modificar'><IMG align='right' SRC='../images/revisar.png' ALT='modificar'></A>";
    }
    else
      $ok = false;
