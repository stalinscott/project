...
<select class="form-control" required="required" name="status" id="status">
  ...
  ?>
        ...
        <center>
          ...
          <a href='../vista/consultar_justificaciones_director.php' class='btn btn-info' role='button'>Volver</a>
          </center>
          </span>
          </label>
          </div>
...
function loadLog() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    xhttp.open("POST", "../director/postmodificarjustificacion.php", true);
