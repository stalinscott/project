    ...
    public function get_products($offset = 0, $limit = 5)
    {
        ...
        try {
               $depuniadm = $_SESSION['depuniadm'];
                    $ofiuniadm = $_SESSION['oficuniadm'];
                    $minorguniadm = $_SESSION['minorguniadm'];
                    $uniuniadm = $_SESSION['uniuniadm'];
                    $prouniadm = $_SESSION['prouniadm'];
            $sql = "SELECT * FROM administrador,personal,rol,sno_unidadadm WHERE administrador.cedper=personal.cedper AND administrador.id_rol=rol.id_rol 
            AND administrador.depuniadm=sno_unidadadm.depuniadm
            AND administrador.oficuniadm=sno_unidadadm.oficuniadm
            ...
            and administrador.depuniadm='$depuniadm' and administrador.oficuniadm='$ofiuniadm' and administrador.minorguniadm='$minorguniadm' and administrador.uniuniadm='$uniuniadm' and administrador.prouniadm='$prouniadm'
            AND administrador.id_rol!='1'
            AND administrador.id_rol!='2' OFFSET ? LIMIT ? 
            ";
