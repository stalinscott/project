...
<div class="panel-heading">
    ...
    include_once('../includes/conexion.php');
        ...
        {
            $sql = "SELECT administrador.cedper, administrador.usuario, administrador.clave, administrador.depuniadm, administrador.oficuniadm, administrador.minorguniadm, 
       administrador.uniuniadm, administrador.prouniadm, administrador.id_rol
  FROM public.administrador WHERE administrador.cedper='$id'";
            $ok = true;
...
<select class="form-control" required="required" name="id_rol" id="id_rol">
  ...
  $sql = "SELECT id_rol, nom_rol FROM public.rol WHERE id_rol!='5' AND id_rol!='6' AND id_rol!='1';";
  $ok = true;
  $rs = pg_query( $conexion, $sql );
...
<div class="form-group">
        ...
        <center>
          ...
          <a href='../vista/consultar_empleado.php' class='btn btn-info' role='button'>Volver</a>
          </center>
          </span>
          </label>
          </div>
