...
<head>
  ...
  <script type="text/javascript" src="../js/jquery.min.js"></script>
    <script type="text/javascript" src="../js/ajax_director_ce.js"></script>
    ...
    <div class="navbar-collapse collapse">
      <div class="container-fluid">
        <ul class="nav navbar-nav">
          ...
          <li  class="active"><a href="empleado_administrador.php"><img src="../images/5.png" alt="#"/> Empleado </a></li>
          <li><a href="asistencia_administrador.php"><img src="../images/6.png" alt="#"/> Asistencia </a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a href="principal.php" class="data-toggle">
...
<div class="sidebar-nav">
      <div class="navbar navbar-default" role="navigation">
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
          <ul class="nav navbar-nav">
          <li><a href="empleado_director.php"><img src="../images/1.2.png" alt="#"/> Empleado</a></li>
  ...
  <h2  align="center">Consultar Empleados</h2>
  <div class="container-fluid">
  <br>
        <!--cargamos los posts-->
