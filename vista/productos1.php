...
class Productos
{
    ...
    public function get_products($offset = 0, $limit = 5)
    {
        ...
        try {
            ...
            $sql = "SELECT * FROM administrador,personal,rol,sno_unidadadm WHERE administrador.cedper=personal.cedper AND administrador.id_rol=rol.id_rol AND administrador.depuniadm=sno_unidadadm.depuniadm
            ...
            AND administrador.prouniadm=sno_unidadadm.prouniadm  OFFSET ? LIMIT ? 
            ";
