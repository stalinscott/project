...
class Productos
{
    ...
    public function get_products($offset = 0, $limit = 5)
    {
        ...
        try {
            ...
            $sql = "SELECT *
  FROM empleado,personal,sn_cargo,sno_unidadadm WHERE empleado.cedper=personal.cedper AND sn_cargo.codcar=personal.codcar AND personal.depuniadm=sno_unidadadm.depuniadm
            AND personal.oficuniadm=sno_unidadadm.oficuniadm
            ...
            and sno_unidadadm.depuniadm='$depuniadm' and sno_unidadadm.oficuniadm='$ofiuniadm' and sno_unidadadm.minorguniadm='$minorguniadm' and sno_unidadadm.uniuniadm='$uniuniadm' and sno_unidadadm.prouniadm='$prouniadm' OFFSET ? LIMIT ?";
