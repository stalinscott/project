		...
		<div class="navbar-collapse collapse">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<li><a href="administrador_root.php"><img src="../images/4.png" alt="#"/>Administrador </a></li>
					<li  class="active"><a href="empleado_root.php"><img src="../images/5.png" alt="#"/>Empleado </a></li>
